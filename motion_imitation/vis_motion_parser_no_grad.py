...
motion_parser = DummyMotionParser(38, policy_net.num_primitives, traj_length=args.steps)
...
class MyVisulizer(Visualizer):
    ...
    def data_generator(self):
        ...
        while True:
            ...
            for t in range(args.steps):
                ...
                beta = motion_parser.get_beta(env.get_obs(),t)
    ...
    def update_pose(self):
        ...
        if args.focus:
            pass
            #self.env_vis.viewer.cam.lookat[:2] = 0.0#self.env_vis.data.qpos[:2]
